...
class BasicForceEffectsAssignment : public Assignment
{
private:
...
void BasicForceEffectsAssignment::initialize(cWorld* world, cCamera* camera)
{
...
void BasicForceEffectsAssignment::updateGraphics()
{

}

void BasicForceEffectsAssignment::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{

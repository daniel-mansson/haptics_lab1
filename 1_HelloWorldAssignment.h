...
class HelloWorldAssignment : public Assignment
{
private:
...
void HelloWorldAssignment::initialize(cWorld* world, cCamera* camera)
{
...
void HelloWorldAssignment::updateGraphics()
{
	std::stringstream ss;
...
void HelloWorldAssignment::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{

...
class HapticWallAssignment : public Assignment
{
private:
...
void HapticWallAssignment::initialize(cWorld* world, cCamera* camera)
{
...
void HapticWallAssignment::updateGraphics()
{

}

void HapticWallAssignment::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{

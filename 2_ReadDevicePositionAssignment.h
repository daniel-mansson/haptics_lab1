...
class ReadDevicePositionAssignment : public Assignment
{
private:
...
void ReadDevicePositionAssignment::initialize(cWorld* world, cCamera* camera)
{
...
void ReadDevicePositionAssignment::updateGraphics()
{

}

void ReadDevicePositionAssignment::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{

...
class MagneticEffectAssignment : public Assignment
{
private:
...
void MagneticEffectAssignment::initialize(cWorld* world, cCamera* camera)
{
...
void MagneticEffectAssignment::updateGraphics()
{

}

void MagneticEffectAssignment::updateHaptics(cGenericHapticDevice* hapticDevice, double timeStep, double totalTime)
{
